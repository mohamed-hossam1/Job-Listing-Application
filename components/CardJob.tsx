      ...
      <div className="border bg-gray-50 rounded-2xl">
        <div className="flex px-20 py-11 items-start">
          ...
          <div className="flex-15 flex flex-col gap-3 ml-8">
            ...
            <p className="text-lg text-gray-500">{jobPosting.about.location}</p>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="border-2 border-amber-400 px-2.5 py-2 rounded-4xl text-amber-400 font-semibold">{jobPosting.about.categories[1]}</span>
              <span className="border-2 border-blue-800 px-6 py-2 rounded-4xl text-blue-800 font-semibold">{jobPosting.about.categories[0]}</span>
            </div>  
          </div>
